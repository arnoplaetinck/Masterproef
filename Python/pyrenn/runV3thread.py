...
class myThread(threading.Thread):
    ...
    def run(self):
        cores.append(psutil.cpu_percent(interval=0.25, percpu=True))

    def run2(self):
        cores.append(psutil.cpu_percent(interval=5, percpu=True))

    def run3(self):
        cores.append(psutil.cpu_percent(interval=24, percpu=True))
